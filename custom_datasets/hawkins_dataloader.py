...
class Hawkins(CustomDataset):
    ...
    def __init__(self,
                 ...
                 dataset_name="hawkins_long_corridor",
                 split="train",
        ...
        self.gt_positives = np.load(
            os.path.join(self.datasets_folder, self.dataset_name,
                         "pose_topic_list.npy"),
            allow_pickle=True)  #returns dictionary of gardens dataset
...
if __name__ == "__main__":
    args = 0
    vpr_ds = Hawkins(
        args, "/ocean/projects/cis220039p/shared/datasets/vpr/datasets_vg",
        "hawkins", 'test')
