...
class Oxford(torch.utils.data.Dataset, CustomDataset):
    ...
    def get_positives(self):
        ...
        if self.soft_positives_per_query is None:
            ...
            self.distances, self.soft_positives_per_query = knn.radius_neighbors(
                self.dbStruct.locQ, radius=self.loc_rad
            )
    ...
    def get_positives_db(self):
        ...
        if self.soft_positives_per_db is None:
            ...
            self.distances, self.soft_positives_per_db = knn.radius_neighbors(
                self.dbStruct.locDb, radius=self.loc_rad
            )
