        ...
        for dataset_name in dataset_name_list:
            ...
            if dataset_name == "gardens":
                self.db_paths = natsorted(
                    os.listdir(
                        os.path.join(
                            self.datasets_folder, self.dataset_name, "day_right"
                        )
                    )
                )
                self.db_abs_paths = []
                ...
                for p in self.db_paths:
                    self.db_abs_paths.append(
                        os.path.join(
                            self.datasets_folder, self.dataset_name, "day_right", p
                        )
                    )
            ...
            # oxford
                ...
                structFile = os.path.join(
                    datasets_folder, "Oxford_Robotcar/oxdatapart.mat"
                )
            ...
            # eiffel
                ...
                self.db_paths = natsorted(
                    os.listdir(
                        os.path.join(
                            self.datasets_folder, self.dataset_name, "db_images"
                        )
                    )
                )
                self.db_abs_paths = []
                ...
                for p in self.db_paths:
                    self.db_abs_paths.append(
                        os.path.join(
                            self.datasets_folder, self.dataset_name, "db_images", p
                        )
                    )
            ...
            # VPAir
                ...
                self.db_paths = natsorted(
                    os.listdir(
                        os.path.join(
                            self.datasets_folder, self.dataset_name, "reference_views"
                        )
                    )
                )
                self.db_abs_paths = []
            ...
            # GNSS Tartan
                ...
                self.db_paths = natsorted(
                    os.listdir(
                        os.path.join(
                            self.datasets_folder, self.dataset_name, "reference_images"
                        )
                    )
                )
                self.db_abs_paths = []
            ...
            # other vg datasets
                ...
                if dataset_name == "pitts30k":
                    self.images_paths = (
                        self.images_paths + list(self.database_paths)[::10]
                    )
                elif dataset_name == "st_lucia":
                    self.images_paths = (
                        self.images_paths + list(self.database_paths)[::2]
                    )
                else:
